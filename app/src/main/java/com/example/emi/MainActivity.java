...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText P = (EditText) findViewById(R.id.principalamount);
        final EditText I = (EditText) findViewById(R.id.interestrate);
        final EditText Y = (EditText) findViewById(R.id.period);
        final EditText TI = (EditText) findViewById(R.id.totalinterest);
